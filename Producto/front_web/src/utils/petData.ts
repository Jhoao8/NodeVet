// Catálogo de especies y razas para el registro de mascotas.
// Copia del catálogo del frontend móvil (src/utils/petData.ts) para que
// ambas plataformas ofrezcan las mismas opciones.
