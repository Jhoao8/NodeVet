// src/screens/Mascotas/DetalleMascotaScreen.tsx
...
export default function DetalleMascotaScreen({ route }: any) {
    // Obtenemos la mascota de los parámetros de la ruta
...
// Componente interno para cada ítem de detalle
...
const styles = StyleSheet.create({
    ...
    infoCard: {
        ...
        borderRadius: 20,
        padding: 20,
        marginTop: -30, // Efecto de tarjeta sobrepuesta
    },
    mainTitle: { fontSize: 32, fontWeight: 'bold', color: colors.darkDGreen, textAlign: 'center' },
    subtitle: { fontSize: 18, color: colors.darkGreen, textAlign: 'center', marginBottom: 20 },
    divider: { height: 1, backgroundColor: '#EEE', marginVertical: 10 },
    detailRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
    item: { flex: 1, alignItems: 'center' },
    itemLabel: { color: '#888', fontSize: 12, marginTop: 5 },
    itemValue: { color: colors.darkDGreen, fontSize: 16, fontWeight: '600' },
});